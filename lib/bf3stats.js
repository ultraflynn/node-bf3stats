...
BF3Stats.prototype.player = function(platform, player, opt, callback) {
	var self = this;
...
BF3Stats.prototype.dogtags = function(platform, player, callback) {
	var self = this;
...
BF3Stats.prototype.server = function(platform, id, callback) {
	var self = this;
...
BF3Stats.prototype.onlinestats = function(platform, callback) {
	var self = this;
...
BF3Stats.prototype.playerupdate = function(platform, time, player, type, callback) {
	var self = this;
...
BF3Stats.prototype.playerlookup = function(platform, time, player, callback) {
	var self = this;
...
BF3Stats.prototype.setupkey = function(platform, time, clientident, name, callback) {
	var self = this;
...
BF3Stats.prototype.getkey = function(platform, time, clientident, callback) {
	var self = this;
